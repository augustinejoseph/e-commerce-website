...
class Order(models.Model):
    ...
    addressLineOne = models.CharField(max_length=100, blank=True, null=True, default=None)
    addressLineTwo = models.CharField(max_length=100, blank=True, null=True, default=None)
...
# old with modifications from the old version
# class OrderProduct(models.Model):
