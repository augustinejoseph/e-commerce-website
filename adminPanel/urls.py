...
from . import views
from .views import UserListView, ProductListView, CategoryListView, OrderListView, EditProduct, EditCategory, EditUser, user_details, UserCreateView, CategoryCreateView, OrderUpdateView, OrderDetailView,ProductCreateView, AdminDashboard
